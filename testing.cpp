...
{   
    ...
    printf("MY --- Find \'a\': %p. Length: %d. Copy: %s. Copy,5symbols: %s. Summ: %s. Summ,5symbols: %s.str == \"kitty\"?: %d.\n", ptr1, leng, arr2, arr3, arr4, arr5, flag);

    char *ptr11 = NULL;
    ptr11 = strchr (test_str, 'a');
    ...
    printf("STD --- Find \'a\': %p. Length: %d. Copy: %s. Copy,5symbols: %s. Summ: %s. Summ,5symbols: %s.str == \"kitty\"?: %d.\n", ptr11, leng1, arr22, arr33, arr44, arr55, flag1);
    /*if (strcmp())
    {
